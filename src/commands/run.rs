...
pub async fn run(model: &str, context_size: u32, n_gpu_layers: i32, verbose: &str) -> Result<()> {
    ...
    crate::inference::llm::run_chat(path_str, context_size, n_gpu_layers, verbose).await
}
